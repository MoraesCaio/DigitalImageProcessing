...
class Filter(object):
    # 0 - identity, 1 - sharpen, 2 - second kernel, 3 - blur, 4 - mean
    matrices = [np.array([[0, 0, 0], [0, 1, 0], [0, 0,  0]]), np.array([[0, -1, 0], [-1, 5, -1], [0, -1, 0]]),
                np.array([[0, 0, 0], [0, 1, 0], [0, 0, -1]]), np.array([[1,  1, 1], [1, 1,  1], [1,  1, 1]]),
                np.array([[1.0/9, 1.0/9, 1.0/9], [1.0/9, 1.0/9, 1.0/9], [1.0/9, 1.0/9, 1.0/9]])]
